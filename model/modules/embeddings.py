...
class Embeddings(nn.Module):
    ...
    Args:
        ...
        位置编码
        position_encoding (bool): see :class:`~modules.PositionalEncoding`
        # 特征融合方式
    ...
    def __init__(self, word_vec_size,
        ...
        self.make_embedding.add_module('word_embedding', self.embedding)
        ...
        if self.position_encoding:
            ...
            self.make_embedding.add_module('positional_encoding', pe)
    ...
    def load_pretrained_vectors(self, emb_file):
        ...
        if emb_file:
            ...
            if self.word_vec_size > pretrained_vec_size:
                self.embedding.weight.data[:, :pretrained_vec_size] = pretrained
