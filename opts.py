...
def model_opts(parser):
    ...
    group.add(
        ...
        action='store_true',
        help=
        'Input and Output use same Tokenizer, when src-tgt are same language.')
    group.add('--split_type',
              '-split_type',
              type=str,
              default='basic',
              help='Word split way.')
    group.add('--src_split_type',
              '-src_split_type',
              type=str,
              default='basic',
              help='src word split way, valid when share_tokenizer=False.')
    group.add('--tgt_split_type',
              '-tgt_split_type',
              type=str,
              default='basic',
              help='tgt word split way, valid when share_tokenizer=False.')
    group.add('--do_lower_case',
              '-do_lower_case',
              action='store_false',
              help='Whether to lower case the input.')
    group.add('--bert_vocab_file',
              '-bert_vocab_file',
              type=str,
              default='./vocab/bert-base-multilingual-uncased-vocab.txt',
    ...
    group.add(
        ...
        type=int,
        default=None,
        help="An artificial maximum length to truncate tokenized sequences to;\
    ...
    group.add('--corpus',
              ...
              type=str,
              default=None,
              help='Corpus used to build vocab.')
    group.add(
        '--src_corpus',
        '-src_corpus',
        type=str,
        default=None,
        help=
        'src corpus used to build input vocab, valid when share_tokenizer=False.'
    )
    group.add(
        '--tgt_corpus',
        '-tgt_corpus',
        ...
        default=None,
        help=
        'tgt corpus used to build output vocab, valid when share_tokenizer=False.'
    )
    group.add(
        '--tnz_load_from',
        '-tnz_load_from',
        ...
        default=None,
        help=
        "Load exist Tokenizer form path, if share_tokenizer=False this param must be a folder path, and 'src_tnz.pkl' & 'tgt_tnz.pkl' in this folder."
    )
    # Embedding Options
    ...
    # save
    group.add('--enc_dim_size',
              '-enc_dim_size',
              type=int,
              default=500,
              help="Size of encoder hidden states. "
              "Must be equal to dec_size.")
    group.add('--dec_dim_size',
              '-dec_dim_size',
              type=int,
              default=500,
              help="Size of decoder hidden states. "
              "Must be equal to enc_dim_size")
...
def train_opts(parser):
    ...
    group.add('--data',
              '-data',
              required=True,
              help='Path prefix to the "train.npy"'
              '"valid.npy" and "test.npy" file path.')
    ...
    group.add('--use_gpu',
              '-use_gpu',
              action='store_true',
              help="Whether to use GPU for training or not.")
    group.add('--gpu_id',
              '-gpu_id',
              default=0,
              type=int,
